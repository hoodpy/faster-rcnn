...
classes = ['__background__', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow', 'diningtable',
'dog', 'horse', 'motorbike', 'person', 'pottedplant', 'sheep', 'sofa', 'train', 'tvmonitor']
model_path = "D:/Documents/faster_rcnn/model/model5000.ckpt"
file_path = "C:/Users/Administrator/jupyter_notebook/Faster-RCNN-TensorFlow-Python3-master/data/demo"
